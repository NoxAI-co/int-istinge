...
@section('content')
	<div class="card-body">
        <p>Esta opción permite crear nuevos planes de velocidad de forma masiva desde un archivo Excel.</p>
        <h4>Tome en cuenta las siguientes reglas para cargar la data</h4>
        <ul>
            <li class="ml-3">
                <form action="{{ route('planes-velocidad.ejemplo-importar') }}" method="post" style="display: inline;">
                    @csrf
            ...
            <li class="ml-3">Los campos obligatorios son <b>Nombre, Referencia, Precio, Vel. de Descarga, Unidad Descarga, Vel. de Subida, Unidad Subida, Mikrotik, Tipo, IVA 19%</b>.</li>
    ...
    <div class="row justify-content-center mt-3">
        <div class="col-md-10">
            <div class="card-body">
                <form action="{{route('planes-velocidad.importar-cargando')}}" method="post" enctype="multipart/form-data" id="importForm">
                    @csrf
                    <div class="row">
        ...
        document.getElementById('importForm').addEventListener('submit', function(e) {
            ...
            var interval = setInterval(function() {
                ...
                if (progress < 30) {
                    ...
                    progressMessage.textContent = 'Creando planes de velocidad...';
                }
            }, 300);
        });
    </script>
