...
@section('boton')
    <x-modules-header titleModule='Editar Persona' description='Edita los datos de la persona' hideActions='true'>
        <x-slot name="icon">
...
<form method="POST" action="{{ route('personas.update', $persona->id) }}" style="padding: 2% 3%;" role="form" class="forms-sample" id="form-contacto">
	...
	<div class="row" style="text-align: right;">
		<div class="col-md-12">
			...
			<button type="submit" id="button-save" class="btn-actions create" style="float: right;">Guardar</button>
		</div>
	</div>
</form>
</div>
