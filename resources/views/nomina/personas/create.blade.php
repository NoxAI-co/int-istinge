...
@section('boton')
    <x-modules-header titleModule='Crear Persona' description='Registra una nueva persona en el sistema' hideActions='true'>
        <x-slot name="icon">
...
@section('content')
    ...
    <form method="POST" action="{{ route('personas.store') }}" style="padding: 2% 3%;" role="form" class="forms-sample"
        ...
        <div class="row" style="text-align: right;">
            <div class="col-md-12">
                <a href="{{route('personas.index')}}" class="btn-actions cancel">Cancelar</a>
                <button type="submit" id="button-save" class="btn-actions create" onclick="guardarPersona(this)">Guardar
                </button>
            </div>
        </div>
    </form>
