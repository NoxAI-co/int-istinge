...
@section('content')
    ...
    <p class="card-description">Libro oficial de compras: consulte el detalle de las facturas de proveedor en un período y expórtelo a Excel.</p>
        ...
        <div class="row card-description">
            <div class="col-md-12">
                <div style="background-color:#000c34; color:#fff; text-align:center; padding:14px 6px; border:1px solid #000c34;">
                    <h3 style="margin:0; font-weight:bold;">Libro oficial de compras</h3>
            ...
            <div class="col-md-12 table-responsive">
                <table class="table table-striped table-hover" id="table-libro-compras">
    ...
    <input type="hidden" id="urlgenerar" value="{{route('reportes.libroCompras')}}">
    <input type="hidden" id="urlexportar" value="{{route('exportar.libroCompras')}}">
@endsection
