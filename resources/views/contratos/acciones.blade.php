...
@if($firma_isp)
    <a href="{{ route('asignaciones.imprimir', ['id' => $id, 'type' => 'contract']) }}"  class="btn btn-outline-danger btn-icons" title="Imprimir Contrato Digital" target="_blank"><i class="fas fa-print"></i></i></a>
@endif
@if($mk == 0)
