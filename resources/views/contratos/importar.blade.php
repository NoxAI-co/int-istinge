...
@section('content')
	<div class="card-body">
        ...
        <ul>
            ...
            <li class="ml-3">Los campos obligatorios son <b>Identificacion, Servicio, Mikrotik, Plan Internet o Plan Television (al menos uno), Estado, IP, Conexion, Interfaz, Segmento, Grupo de Corte, Facturacion, Tecnologia</b>.</li>
