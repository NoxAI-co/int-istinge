...
<div id="whatsapp-chat-app">
    ...
    <div class="chat-toolbar">
        <div class="flex items-center" style="max-width: 70%;">
            <svg style="width: 24px; height: 24px; margin-right: 10px; flex-shrink: 0;" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div style="display: flex; align-items: center; flex-wrap: wrap;">
                ...
                <div v-if="lastMessageError && lastMessageError.critical" class="top-error-notification">
                    <strong>@{{ lastMessageError.title }}</strong>
                    <span>@{{ lastMessageError.detail }}</span>
                </div>
            </div>
        </div>
