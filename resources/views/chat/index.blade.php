    ...
    computed: {
        ...
        lastMessageError() {
            if (this.selectedConversation && this.selectedConversation.has_undeliverable_warning) {
                return {
                    title: 'Atención',
                    detail: 'La siguiente linea telefonica segun nuestros analisis probablemente no tiene una linea de whatsapp activa, intenta comunicarte enviar el documento con otra alternativa.',
                    critical: true
                };
            }
