    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <h3>Detalles de Asignación de Material</h3>
                    </div>
                    <div class="col-md-6 text-right">
                        <a href="{{ route('asignacion_material.pdf', $material_asignado->id) }}" target="_blank" class="btn btn-outline-danger">
                            <i class="far fa-file-pdf"></i> Imprimir PDF
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-hover">
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $material_asignado->referencia }}</td>
                            </tr>
                            <tr>
                                <th>Técnico:</th>
                            ...
                            <tr>
                                <th>Fecha:</th>
                                <td>{{ date('d-m-Y', strtotime($material_asignado->fecha)) }}</td>
                            </tr>
                            <tr>
                                <th>Notas:</th>
                                <td>{{ $material_asignado->notas }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>

                <h4 class="mt-4">Materiales Asignados</h4>
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
