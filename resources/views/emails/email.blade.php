                                            ...
                                            <tr>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr bgcolor="#ffffff">
                                                                <td style="padding:0px 30px">
                                                                    <div style="text-align:left;line-height:22px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:normal;margin-top:0px"> {{Auth::user()->empresa()->nombre}} le informa que se generó la siguiente factura</div>
                                                                    <br>
                                                                </td>
                                                            </tr>
                                                            <tr bgcolor="#ffffff">
                                                                <td style="padding:10px 30px">
                                                                    <table align="center" style="width:80%;height:64px;margin:0 auto;font-size:9pt;font-family:Arial,Helvetica,sans-serif;border:none;background-color:#f0f0f0;color:#000">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><strong>{{Auth::user()->empresa()->moneda}} {{$total}}</strong></td>
                                                                        </tr>
                                                                    </tbody></table>
                                                                </td>
                                                ...
                                                <tr>
                                                    <td style="padding:0px 30px 0px 30px">
                                                        ...
                                                        Factura elaborada y enviada a través de {{Auth::user()->empresa()->nombre}}</div>
                                                        <center>
