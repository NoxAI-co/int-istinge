                ...
                <tr>
                    <td>
                        ...
                        <div style="width: 100%;  margin-top: 5px; border: 1px  solid #000;">
                            ...
                            <p style="text-align: justify; margin-bottom: 3px;" class="small pl-2">Tipo red: FTTH <input type="checkbox" {{$contract->tecnologia == 1 ? 'checked="checked' : ''}}> WIRELESS <input type="checkbox" {{$contract->tecnologia == 2 ? 'checked="checked' : ''}}></p>
                            @endif
                            ...
                            <table style="width: 100%; text-align:center; padding:5px;">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 9px;"><b>{{$company->moneda}} {{ isset($contractDetails->server_configuration_id) ? App\Funcion::Parsear($total_internet) : '________' }}</b></td>
                                    <td style="font-size: 9px;">Total</td>
                                    <td style="font-size: 9px;">{{$company->moneda}} {{ isset($contractDetails->server_configuration_id) ? App\Funcion::Parsear($total_internet) : '________' }}</td>
                                </tr>
                            </table>
                            ...
                            <table style="width: 100%; text-align:center; padding:5px;">
                                ...
                                <tr>
                                    <td style="font-size: 9px;">Valor</td>
                                    <td style="font-size: 9px;">{{$company->moneda}} {{ isset($contract->servicio_tv) ? App\Funcion::Parsear($total_tv) : '________' }}</td>
                                    <td style="font-size: 9px;">Total</td>
                                    <td style="font-size: 9px;">{{$company->moneda}} {{ isset($contract->servicio_tv) ? App\Funcion::Parsear($total_tv) : '________' }}</td>
                                </tr>
                            </table>
                    ...
                    <td style="vertical-align:top;" width="50%">
                        ...
                        <p style="text-align: justify; margin-bottom: 6px;" class="small">Cuando se presente indisponibilidad del servicio o este se suspenda a pesar de su pago oportuno, lo compensaremos en su próxima factura. Debemos cumplir con las condiciones de calidad definidas por la CRC.<br>Consúltelas en la página: {{ $company->web }}</p>
