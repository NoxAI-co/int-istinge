    ...
    <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav navbar-nav-right d-block">
            ...
            <li class="nav-item dropdown d-none d-inline-block">
                ...
                <span id="div_saldo" class="d-block mt-1 mb-1 d-lg-inline-flex font-weight-bold text-white small" style="background: #000000; color: #ffffff; padding: 10px 20px; border-radius: 15px;">SALDO: {{Auth::user()->empresa()->moneda}}{{ App\Funcion::Parsear(Auth::user()->saldo) }}</span>
            </li>
            @endif
