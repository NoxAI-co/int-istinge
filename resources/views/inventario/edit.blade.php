...
<form method="POST" action="{{ route('inventario.update',$inventario->id) }}" style="padding: 2% 3%;" role="form" class="forms-sample" novalidate id="form-inventario" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="form-group col-md-3">
				...
				<input type="text" class="form-control" name="nro_serial" id="nro_serial" maxlength="200" value="{{$inventario->nro_serial}}">
				<span class="help-block error">
									...
									<div class="form-group col-md-12">
										...
										<div class="d-flex align-items-center">
											<label class="switch mb-0">
												...
												<input type="checkbox" name="facturar_otra_empresa" id="facturar_otra_empresa" value="1" {{ isset($inventario->nombre_empresa) && $inventario->nombre_empresa != '' ? 'checked' : '' }}>
												<span class="slider round"></span>
											</label>
											<span class="ml-2" id="facturar_otra_empresa_label">{{ isset($inventario->nombre_empresa) && $inventario->nombre_empresa != '' ? 'Sí' : 'No' }}</span>
										</div>
									</div>
								</div>
								<div class="row" id="div_empresa_facturacion" style="{{ isset($inventario->nombre_empresa) && $inventario->nombre_empresa != '' ? '' : 'display:none;' }}">
									<div class="form-group col-md-4">
										<label class="control-label">Nombre / Razón Social</label>
										<input type="text" class="form-control" name="nombre_empresa" id="nombre_empresa" value="{{ isset($inventario->nombre_empresa) ? $inventario->nombre_empresa : '' }}" maxlength="200">
									</div>
									<div class="form-group col-md-3">
										<label class="control-label">NIT</label>
										<input type="text" class="form-control" name="nit_empresa" id="nit_empresa" value="{{ isset($inventario->nit_empresa) ? $inventario->nit_empresa : '' }}" maxlength="20" onkeyup="calcularDV()">
									</div>
									<div class="form-group col-md-2">
										<label class="control-label">Dígito de Verificación</label>
										<input type="text" class="form-control" name="dv_empresa" id="dv_empresa" value="{{ isset($inventario->dv_empresa) ? $inventario->dv_empresa : '' }}" readonly style="background-color: #e9ecef;">
									</div>
									<div class="form-group col-md-4">
										<label class="control-label">Dirección</label>
										<input type="text" class="form-control" name="direccion_empresa" id="direccion_empresa" value="{{ isset($inventario->direccion_empresa) ? $inventario->direccion_empresa : '' }}" maxlength="200">
									</div>
									<div class="form-group col-md-4">
										<label class="control-label">Email</label>
										<input type="email" class="form-control" name="email_empresa" id="email_empresa" value="{{ isset($inventario->email_empresa) ? $inventario->email_empresa : '' }}" maxlength="200">
									</div>
								</div>
							</div>
						</div>
