    				...
    				<tbody>
                        ...
                        @if ($radicado->adjunto_audio)
    						<tr>
    							...
    							<td>
    								<a href="{{ contabo_url(env('ADJUNTOS_FOLDER', 'adjuntos'), $radicado->adjunto_audio) }}" target="_blank" class="btn btn-outline-success btn-sm btn-icons" style="border-radius: 50%;" title="Escuchar audio"><i class="fas fa-eye"></i>
    	                        </td>
    						</tr>
    					@endif
    					@if(($radicado->adjunto) || ($radicado->adjunto_1) || ($radicado->adjunto_2) || ($radicado->adjunto_3) || ($radicado->adjunto_4))
    					    <tr id="tr_adjunto">
    							...
    							<td>
                                    @if ($radicado->adjunto)
                                        {{-- Archivo 1.. --}}
    								    <a href="{{ contabo_url(env('ADJUNTOS_FOLDER', 'adjuntos'), $radicado->adjunto) }}" target="_blank" class="btn btn-outline-success btn-sm btn-icons" style="border-radius: 50%;" title="Ver Adjunto"><i class="fas fa-eye"></i>
                                    ...
                                    @if ($radicado->adjunto_1)
                                    {{-- Archivo 2 --}}
                                        <a href="{{ contabo_url(env('ADJUNTOS_FOLDER', 'adjuntos'), $radicado->adjunto_1) }}" target="_blank" class="btn btn-outline-success btn-sm btn-icons" style="border-radius: 50%;" title="Ver Adjunto 1"><i class="fas fa-eye"></i>
                                    ...
                                    @endif
                                    @if ($radicado->adjunto_2)
                                        <a href="{{ contabo_url(env('ADJUNTOS_FOLDER', 'adjuntos'), $radicado->adjunto_2) }}" target="_blank" class="btn btn-outline-success btn-sm btn-icons" style="border-radius: 50%;" title="Ver Adjunto 2"><i class="fas fa-eye"></i>
                                    ...
                                    @endif
                                    @if ($radicado->adjunto_3)
                                        <a href="{{ contabo_url(env('ADJUNTOS_FOLDER', 'adjuntos'), $radicado->adjunto_3) }}" target="_blank" class="btn btn-outline-success btn-sm btn-icons" style="border-radius: 50%;" title="Ver Adjunto 3"><i class="fas fa-eye"></i>
                                    ...
                                    {{-- Archivo 5 --}}
                                    @if ($radicado->adjunto_4)
                                        <a href="{{ contabo_url(env('ADJUNTOS_FOLDER', 'adjuntos'), $radicado->adjunto_4) }}" target="_blank" class="btn btn-outline-success btn-sm btn-icons" style="border-radius: 50%;" title="Ver Adjunto 4"><i class="fas fa-eye"></i>
                                    ...
                                    @endif
                                    @if ($radicado->adjunto_5)
                                        <a href="{{ contabo_url(env('ADJUNTOS_FOLDER', 'adjuntos'), $radicado->adjunto_5) }}" target="_blank" class="btn btn-outline-success btn-sm btn-icons" style="border-radius: 50%;" title="Ver Adjunto 5"><i class="fas fa-eye"></i>
                                    ...
                                    @endif
                                    @if ($radicado->adjunto_6)
                                        <a href="{{ contabo_url(env('ADJUNTOS_FOLDER', 'adjuntos'), $radicado->adjunto_6) }}" target="_blank" class="btn btn-outline-success btn-sm btn-icons" style="border-radius: 50%;" title="Ver Adjunto 6"><i class="fas fa-eye"></i>
                                    ...
                                    @endif
                                    {{-- @if ($radicado->adjunto_audio)
                                        <a href="{{ contabo_url(env('ADJUNTOS_FOLDER', 'adjuntos'), $radicado->adjunto_audio) }}" target="_blank" class="btn btn-outline-success btn-sm btn-icons" style="border-radius: 50%;" title="Ver Adjunto 4"><i class="fas fa-eye"></i>
