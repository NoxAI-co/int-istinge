    ...
    public function ventas(Request $request){
        ...
        if ($request->nro == 'remisiones'){
            ...
            foreach ($facturas as $factura) {
                ...
                ->setCellValue($letras[21].$i, date('d-m-Y', strtotime($factura->pagada)))
                ->setCellValue($letras[22].$i, $total->valImpuesto)
                ->setCellValue($letras[23].$i, $total->subtotal)
                ->setCellValue($letras[24].$i, $total->descuento)
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue($letras[25].$i, "TOTAL: ")
                ->setCellValue($letras[26].$i, Auth::user()->empresa()->moneda." ".Funcion::Parsear($pagadoTotal));
