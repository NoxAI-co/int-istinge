...
Route::group(['prefix' => 'empresa', 'middleware' => ['auth']], function () {
	...
	Route::group(['prefix' => 'contactos'], function () {
		...
		Route::post('correo-generico', 'ContactosController@asignarCorreoGenerico')->name('contactos.correoGenerico');
	});
	...
	Route::group(['prefix' => 'contratos'], function () {
		...
		Route::get('{contratos}/destroy_lote', 'ContratosController@destroy_lote')->name('contratos.destroy_lote');
